...
- No-Move tick WC/streak, active skill/eligible Attack cooldown và hazard timer; Bomb fuse/status tick mỗi beat.
...
| [Skill và item](./skills-and-items.md) | Ba slot và sáu skill hiện tại |
...
| Bomb skill fuse | Timer của Bomb đã đặt, tick mỗi beat; tách khỏi cooldown skill slot |
